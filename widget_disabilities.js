...
var bg_color_icon = '';
var conditional = ["ppid.banjarmasinkota.go.id", "spbe.banjarmasinkota.go.id", "banjarmasinkota.go.id", "diskominfotik.banjarmasinkota.go.id", "www.banjarmasinkota.go.id", "smartcity.banjarmasinkota.go.id"];
...
var except_url_jquery_v3 = ["ppid.banjarmasinkota.go.id", "spbe.banjarmasinkota.go.id", "banjarmasinkota.go.id", "www.banjarmasinkota.go.id", "diskominfotik.banjarmasinkota.go.id", "smartcity.banjarmasinkota.go.id"];
