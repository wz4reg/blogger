...
var except_url_jquery_v3 = ["diskominfotik.banjarmasinkota.go.id", "spbe.banjarmasinkota.go.id", "ppid.banjarmasinkota.go.id", "smartcity.banjarmasinkota.go.id", "www.banjarmasinkota.go.id", "lapor.banjarmasinkota.go.id"];
